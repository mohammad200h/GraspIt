// Generated by gencpp from file sr_robot_msgs/ActuatorStatistics.msg
// DO NOT EDIT!


#ifndef SR_ROBOT_MSGS_MESSAGE_ACTUATORSTATISTICS_H
#define SR_ROBOT_MSGS_MESSAGE_ACTUATORSTATISTICS_H
...
struct ActuatorStatistics_
{
  ...
  typedef boost::shared_ptr< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> const> ConstPtr;

}; // struct ActuatorStatistics_

typedef ::sr_robot_msgs::ActuatorStatistics_<std::allocator<void> > ActuatorStatistics;

typedef boost::shared_ptr< ::sr_robot_msgs::ActuatorStatistics > ActuatorStatisticsPtr;
typedef boost::shared_ptr< ::sr_robot_msgs::ActuatorStatistics const> ActuatorStatisticsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc37184273b29627dULL;
  static const uint64_t static_value2 = 0xe29382f1d3670175ULL;
};

template<class ContainerAllocator>
struct DataType< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> >
{
  static const char* value()
  {
    return "sr_robot_msgs/ActuatorStatistics";
  }
...
template<class ContainerAllocator>
struct Definition< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sr_robot_msgs::ActuatorStatistics_<ContainerAllocator>& v)
  {
    s << indent << "name: ";
...
#endif // SR_ROBOT_MSGS_MESSAGE_ACTUATORSTATISTICS_H
