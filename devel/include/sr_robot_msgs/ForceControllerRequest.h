...
struct ForceControllerRequest_
{
  ...
  _sign_type sign;
   ...
   typedef int16_t _torque_limit_type;
  _torque_limit_type torque_limit;

   typedef int16_t _torque_limiter_gain_type;
  _torque_limiter_gain_type torque_limiter_gain;
...
struct MD5Sum< ::sr_robot_msgs::ForceControllerRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xed276d9ce996f859ULL;
  static const uint64_t static_value2 = 0xe20d6bd1f9b633f5ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sr_robot_msgs::ForceControllerRequest_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.torque_limiter_gain);
    }
...
struct Printer< ::sr_robot_msgs::ForceControllerRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sr_robot_msgs::ForceControllerRequest_<ContainerAllocator>& v)
  {
    ...
    Printer<int16_t>::stream(s, indent + "  ", v.torque_limit);
    s << indent << "torque_limiter_gain: ";
    Printer<int16_t>::stream(s, indent + "  ", v.torque_limiter_gain);
  }
};
