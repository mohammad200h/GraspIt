...
"""autogenerated by genpy from graspit_interface/PlanGraspsActionResult.msg. Do not edit."""
import sys
...
class PlanGraspsActionResult(genpy.Message):
  _md5sum = "fd8300a0bf4b8ddae5218e2bf174980f"
  _type = "graspit_interface/PlanGraspsActionResult"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','graspit_interface/PlanGraspsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanGraspsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = graspit_interface.msg.PlanGraspsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = graspit_interface.msg.PlanGraspsResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.result.grasps:
        ...
        _x = _v7
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.result.energies)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.result.energies))
      _x = self.result.search_energy
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.result.energies = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.search_energy = str[start:end].decode('utf-8')
      else:
        self.result.search_energy = str[start:end]
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.result.energies.tostring())
      _x = self.result.search_energy
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.result.energies = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
