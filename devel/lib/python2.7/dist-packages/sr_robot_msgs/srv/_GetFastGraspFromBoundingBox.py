...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_B().pack(self.bounding_box.type))
      length = len(self.bounding_box.dimensions)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.bounding_box.dimensions))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.bounding_box.dimensions = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
