...
"""autogenerated by genpy from sr_robot_msgs/GraspActionResult.msg. Do not edit."""
import sys
...
class GraspActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "sr_robot_msgs/GraspActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sr_robot_msgs/GraspResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = sr_robot_msgs.msg.GraspResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = sr_robot_msgs.msg.GraspResult()
