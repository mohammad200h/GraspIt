...
int16 data"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sh'%length
      buff.write(struct.pack(pattern, *self.sensors))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sh'%length
      buff.write(struct.pack(pattern, *self.motor_data_packet_torque))
      length = len(self.motor_data_packet_misc)
      buff.write(_struct_I.pack(length))
      pattern = '<%sh'%length
      buff.write(struct.pack(pattern, *self.motor_data_packet_misc))
      _x = self
      buff.write(_get_struct_ih().pack(_x.tactile_data_type, _x.tactile_data_valid))
      length = len(self.tactile)
      buff.write(_struct_I.pack(length))
      pattern = '<%sh'%length
      buff.write(struct.pack(pattern, *self.tactile))
      buff.write(_get_struct_h().pack(self.idle_time_us))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.sensors = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      self.motor_data_packet_torque = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sh'%length
      ...
      self.motor_data_packet_misc = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 6
      ...
      self.tactile = struct.unpack(pattern, str[start:end])
      start = end
      end += 2
