...
"""autogenerated by genpy from sr_robot_msgs/PlanGraspGoal.msg. Do not edit."""
import sys
...
class PlanGraspGoal(genpy.Message):
  _md5sum = "b534d92b2db78731fd9d596759e73967"
  _type = "sr_robot_msgs/PlanGraspGoal"
...
"""
  __slots__ = ['object']
  _slot_types = ['object_recognition_msgs/RecognizedObject']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanGraspGoal, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.object.confidence))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_7d().pack(_x.object.pose.pose.pose.position.x, _x.object.pose.pose.pose.position.y, _x.object.pose.pose.pose.position.z, _x.object.pose.pose.pose.orientation.x, _x.object.pose.pose.pose.orientation.y, _x.object.pose.pose.pose.orientation.z, _x.object.pose.pose.pose.orientation.w))
      buff.write(_get_struct_36d().pack(*self.object.pose.pose.covariance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.object.confidence,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (_x.object.pose.pose.pose.position.x, _x.object.pose.pose.pose.position.y, _x.object.pose.pose.pose.position.z, _x.object.pose.pose.pose.orientation.x, _x.object.pose.pose.pose.orientation.y, _x.object.pose.pose.pose.orientation.z, _x.object.pose.pose.pose.orientation.w,) = _get_struct_7d().unpack(str[start:end])
      start = end
      end += 288
      self.object.pose.pose.covariance = _get_struct_36d().unpack(str[start:end])
      return self
