...
"""autogenerated by genpy from sr_robot_msgs/PlanGraspActionResult.msg. Do not edit."""
import sys
...
class PlanGraspActionResult(genpy.Message):
  _md5sum = "3e5cdae81cffa49b72e6fc3e16366194"
  _type = "sr_robot_msgs/PlanGraspActionResult"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sr_robot_msgs/PlanGraspResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanGraspActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = sr_robot_msgs.msg.PlanGraspResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = sr_robot_msgs.msg.PlanGraspResult()
