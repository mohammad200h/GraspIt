...
"""autogenerated by genpy from sr_robot_msgs/PlanGraspActionFeedback.msg. Do not edit."""
import sys
...
class PlanGraspActionFeedback(genpy.Message):
  _md5sum = "a2ce8eb84156740e6dd836be2402edf6"
  _type = "sr_robot_msgs/PlanGraspActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sr_robot_msgs/PlanGraspFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanGraspActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = sr_robot_msgs.msg.PlanGraspFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = sr_robot_msgs.msg.PlanGraspFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.feedback.number_of_synthesized_grasps))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.number_of_synthesized_grasps,) = _get_struct_i().unpack(str[start:end])
      return self
