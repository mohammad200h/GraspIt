...
"""autogenerated by genpy from sr_robot_msgs/MechanismStatistics.msg. Do not edit."""
import sys
...
class MechanismStatistics(genpy.Message):
  ...
  _type = "sr_robot_msgs/MechanismStatistics"
...
time time_last_control_loop_overrun"""
  ...
  _slot_types = ['std_msgs/Header','sr_robot_msgs/ActuatorStatistics[]','sr_robot_msgs/JointStatistics[]','sr_robot_msgs/ControllerStatistics[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = sr_robot_msgs.msg.ActuatorStatistics()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
      ...
      self.joint_statistics = []
      for i in range(0, length):
        val1 = sr_robot_msgs.msg.JointStatistics()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
      ...
      self.controller_statistics = []
      for i in range(0, length):
        val1 = sr_robot_msgs.msg.ControllerStatistics()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
