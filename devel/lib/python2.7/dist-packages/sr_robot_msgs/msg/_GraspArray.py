...
"""autogenerated by genpy from sr_robot_msgs/GraspArray.msg. Do not edit."""
import sys
...
class GraspArray(genpy.Message):
  _md5sum = "8c4083a4efa926cd066c287f905843a3"
  _type = "sr_robot_msgs/GraspArray"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# An array of moveit grasps. Useful for serialisation.
...
float64 z"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspArray, self).__init__(*args, **kwds)
