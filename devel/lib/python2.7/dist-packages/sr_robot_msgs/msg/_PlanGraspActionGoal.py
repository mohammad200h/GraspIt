...
"""autogenerated by genpy from sr_robot_msgs/PlanGraspActionGoal.msg. Do not edit."""
import sys
...
class PlanGraspActionGoal(genpy.Message):
  ...
  _type = "sr_robot_msgs/PlanGraspActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','sr_robot_msgs/PlanGraspGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = sr_robot_msgs.msg.PlanGraspGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = sr_robot_msgs.msg.PlanGraspGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.goal.object.confidence))
      ...
      for val1 in self.goal.object.bounding_contours:
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self
      buff.write(_get_struct_3I().pack(_x.goal.object.pose.header.seq, _x.goal.object.pose.header.stamp.secs, _x.goal.object.pose.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_7d().pack(_x.goal.object.pose.pose.pose.position.x, _x.goal.object.pose.pose.pose.position.y, _x.goal.object.pose.pose.pose.position.z, _x.goal.object.pose.pose.pose.orientation.x, _x.goal.object.pose.pose.pose.orientation.y, _x.goal.object.pose.pose.pose.orientation.z, _x.goal.object.pose.pose.pose.orientation.w))
      buff.write(_get_struct_36d().pack(*self.goal.object.pose.pose.covariance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.object.confidence,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (_x.goal.object.pose.header.seq, _x.goal.object.pose.header.stamp.secs, _x.goal.object.pose.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.goal.object.pose.pose.pose.position.x, _x.goal.object.pose.pose.pose.position.y, _x.goal.object.pose.pose.pose.position.z, _x.goal.object.pose.pose.pose.orientation.x, _x.goal.object.pose.pose.pose.orientation.y, _x.goal.object.pose.pose.pose.orientation.z, _x.goal.object.pose.pose.pose.orientation.w,) = _get_struct_7d().unpack(str[start:end])
      start = end
      end += 288
      self.goal.object.pose.pose.covariance = _get_struct_36d().unpack(str[start:end])
      return self
