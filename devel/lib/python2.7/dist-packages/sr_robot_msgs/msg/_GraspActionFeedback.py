...
"""autogenerated by genpy from sr_robot_msgs/GraspActionFeedback.msg. Do not edit."""
import sys
...
class GraspActionFeedback(genpy.Message):
  _md5sum = "2d6998e848fff41089626ae64226c4cd"
  _type = "sr_robot_msgs/GraspActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sr_robot_msgs/GraspFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = sr_robot_msgs.msg.GraspFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = sr_robot_msgs.msg.GraspFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_Bd().pack(_x.feedback.state, _x.feedback.quality))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.state, _x.feedback.quality,) = _get_struct_Bd().unpack(str[start:end])
      return self
