...
class PlanGraspsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PlanGraspsFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlanGraspsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PlanGraspsActionFeedback(null);
    ...
    data.feedback = PlanGraspsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PlanGraspsFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanGraspsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PlanGraspsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PlanGraspsFeedback()
    }
...
module.exports = PlanGraspsActionFeedback;
