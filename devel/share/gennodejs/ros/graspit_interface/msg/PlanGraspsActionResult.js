...
class PlanGraspsActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new PlanGraspsResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlanGraspsResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PlanGraspsResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanGraspsActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = PlanGraspsResult.Resolve(msg.result)
    }
    else {
      resolved.result = new PlanGraspsResult()
    }
...
module.exports = PlanGraspsActionResult;
