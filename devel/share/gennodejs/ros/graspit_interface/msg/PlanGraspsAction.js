...
class PlanGraspsAction {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('action_goal')) {
        ...
        this.action_goal = new PlanGraspsActionGoal();
      }
      if (initObj.hasOwnProperty('action_result')) {
        this.action_result = initObj.action_result
      }
      else {
        this.action_result = new PlanGraspsActionResult();
      }
      if (initObj.hasOwnProperty('action_feedback')) {
        this.action_feedback = initObj.action_feedback
      }
      else {
        this.action_feedback = new PlanGraspsActionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlanGraspsActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = PlanGraspsActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = PlanGraspsActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PlanGraspsAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = PlanGraspsActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = PlanGraspsActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = PlanGraspsActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += PlanGraspsActionGoal.getMessageSize(object.action_goal);
    length += PlanGraspsActionResult.getMessageSize(object.action_result);
    length += PlanGraspsActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanGraspsAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = PlanGraspsActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new PlanGraspsActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = PlanGraspsActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new PlanGraspsActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = PlanGraspsActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new PlanGraspsActionFeedback()
    }
...
module.exports = PlanGraspsAction;
