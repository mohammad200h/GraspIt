...
get_filename_component(_filename "/home/mamad/Graspit/src/shadow_dep/sr_core/sr_utilities/srv/getJointState.srv" NAME_WE)
add_custom_target(_sr_utilities_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "sr_utilities" "/home/mamad/Graspit/src/shadow_dep/sr_core/sr_utilities/srv/getJointState.srv" "sensor_msgs/JointState:std_msgs/Header"
)
...
_generate_srv_cpp(sr_utilities
  "/home/mamad/Graspit/src/shadow_dep/sr_core/sr_utilities/srv/getJointState.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/sr_utilities)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/sr_utilities\")")
  # install generated code
  install(
