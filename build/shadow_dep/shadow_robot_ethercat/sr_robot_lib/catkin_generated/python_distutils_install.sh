...
echo_and_run cd "/home/mamad/Graspit/src/shadow_dep/shadow_robot_ethercat/sr_robot_lib"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/mamad/Graspit/build/shadow_dep/shadow_robot_ethercat/sr_robot_lib" \
    install \
    $DESTDIR_ARG \
